...
import { LibrasChat, type LibrasChatMessage, type LibrasChatRole } from '../libras';
    ...
    <div className="call">
      ...
      <div className="call__grid">
        <section className="call__panel">
          ...
          <LibrasChat role="doctor" messages={messages} onSend={send('doctor')} />
        </section>
        ...
        <section className="call__panel">
          ...
          <LibrasChat role="client" messages={messages} onSend={send('client')} />
        </section>
      </div>
